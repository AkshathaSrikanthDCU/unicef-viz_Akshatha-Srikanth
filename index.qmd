...
---
title: "UNICEF Child Mortality Visualization"
format: html
theme: lux
---
...
Child mortality rates provide critical insights into a country's healthcare, education, and overall socio-economic conditions.  
This visualization explores deaths among children aged 5 to 9 years across different countries and over time, using UNICEF data.
...
1. Save the `index.qmd`.
2. Then in PowerShell:

```bash
quarto render index.qmd
git add .
git commit -m "Add Introduction and Conclusion"
git push
